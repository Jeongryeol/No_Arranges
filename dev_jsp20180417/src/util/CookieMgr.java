 ...
 *          ▷ bindCookies <br>
 *          1.4 <br>
 *          ▷ isNumber() 추가 : 실수 및 음수에 대한 문자열 확인+인코딩+디코딩 외 일부 수정 <br>
 *          1.3 <br>
 *          ▷ showAllCookieList() 추가 <br>
 *          1.2 <br>
 *          ▷ 쿠키만들기 오버로드 메소드 추가 <br>
 *          1.1 <br>
 *          ▷ 유효시간설정 , 경로설정 추가 <br>
 *          1.0 <br>
 *          ▷ 최초배포
 * @author Jeongryoel Lee(이정렬) <br>
 *         테스터 : 박의, 이현영
 * 
 * @안내사항 사용시 원하는 기능만 펼쳐서 학습하길 권장합니다. <br>
 *       아래 순서대로 정리되어 있습니다. <br>
 *       링크를 클릭해서 세부주석을 확인하시기 바랍니다. <br>
 *       ─────────────────────────────────────────────────────────────────────────────────────────────────────────
 * @생성자 인스턴스호출 <br>
 *      {@linkplain #CookieMgr(HttpServletRequest req, HttpServletResponse res)}
 *      <br>
 *      request/responser객체 전역변수 초기화 <br>
 *      생성된 쿠키를 맵에 담기 <br>
 *      ─────────────────────────────────────────────────────────────────────────────────────────────────────────
 * @확인하기_1 이름으로_존재확인 <br>
 *         {@linkplain #checkCookie(String targetCookieName)} <br>
 *         return : boolean
 * @확인하기_2 모든_쿠키_출력하기_콘솔창 <br>
...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
	...
	public void setCookie(String cookieName, String value) throws IOException {
		...
		logger.info("[[ 쿠키매니저 ]] 쿠키가 응답객체에 담겼습니다. / " + cookieName + ":" + value
				+ "			※참고-모든쿠키보기 : showAllCookie_console();");
