...
<%
String q1a = request.getParameter("q1");
%>

<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=EUC-KR">
<title>Question 1번</title>
<script type="text/javascript">
	...
	function next(){
		...
		document.getElementById("h1").value = innA;
...
<body>
<form name="n_q1" id="i_q1" method="get" action="./OnLineTest_2.jsp">
