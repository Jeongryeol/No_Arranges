...
<title>Question 5번</title>
<script type="text/javascript">
	var dap;
	function prev(){
	      location.href = "./OnLineTest_4.jsp";//페이지 이동이 일어남.
	}
	function next(){
		var innA = "";
		...
		document.getElementById("h5").value = innA;
...
<body>
<form name="n_q1" id="i_q1" method="post" action="./OnLineTest_Account.jsp">
...
&nbsp;&nbsp;&nbsp;<input type="button" value="제출전 확인하기" onClick="next()">
</form>
</body>
</html>