...
<title>Question 3번</title>
<script type="text/javascript">
	var dap;
	function prev(){
	      location.href = "./OnLineTest_2.jsp";//페이지 이동이 일어남.
	}
	function next(){
		var innA = "";
		...
		document.getElementById("h3").value = innA;
...
<body>
<form name="n_q1" id="i_q1" method="post" action="./OnLineTest_4.jsp">
